...
RegisterNUICallback('escape', function(data, cb)
    ...
    TriggerEvent("HJ_notepad:CloseNotepad")
end)
...
RegisterNetEvent("HJ_notepad:OpenNotepadGui")
AddEventHandler("HJ_notepad:OpenNotepadGui", function()
    if not isUiOpen then
        openGui()
    end
end)

RegisterNetEvent("HJ_notepad:CloseNotepad")
AddEventHandler("HJ_notepad:CloseNotepad", function()
    SendNUIMessage({
        action = 'closeNotepad'
    })
...
RegisterNetEvent('HJ_notepad:note')
AddEventHandler('HJ_notepad:note', function()
    ...
    if ( DoesEntityExist( player ) and not IsEntityDead( player )) then 
        ...
        if ( IsEntityPlayingAnim( player, ad, "base", 3 ) ) then 
            ...
            AttachEntityToEntity(prop, player, GetPedBoneIndex(player, 18905), 0.1, 0.02, 0.05, 10.0, 0.0, 0.0, true, true, false, true, 1, true) -- HJ_notepadpad
...
RegisterNetEvent('HJ_notepad:updateNotes')
AddEventHandler('HJ_notepad:updateNotes', function(serverNotesPassed)
